...
## 신규 작업
- [ ] PDF 다운로드 기능 수정 (직원관리·조직도)
- [ ] 엑셀 직원 추가 필드 활성화 (부서·직급·직책·근무지 등 전체 필드 매핑)
- [ ] 설정 페이지에 부서·직급·직책·근무지 관리 탭 추가
- [ ] 신규직원 등록 폼에서 보유스킬·초기참여점수 필드 제거
- [ ] 아바타 이름 표기 전체 이름 또는 이름만 표시
- [ ] 직원 추가 오류 수정
- [ ] 조직도 DB 연동 - 직원 추가 시 자동 반영
- [ ] 문서관리 탭 활성화 (업로드·목록·다운로드)
